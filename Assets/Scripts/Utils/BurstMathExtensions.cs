...
namespace Utils {
    ...
    public static class BurstMathExtensions {
        ...
        [BurstCompile]
        public static bool AndReduce(this bool2 val) => val.x && val.y;
    ...
    public static class VectorExtension {
        ...
        public static int2 Int2(this Vector2Int vec) => new(vec.x, vec.y);
        
        public static int2 Int2(this Vector2 vec) => Vector2Int.FloorToInt(vec).Int2();
    }
